...
describe('when there are initially some users saved', () => {
    ...
    describe('POST', () => {
        ...
        test('user with too short username (< 3) cannot be added', async () => {
            ...
            assert(result._body.error.includes('username') 
                && result._body.error.includes('is shorter than the minimum allowed length (3)'))
        ...
        test('user with too short password (< 3) cannot be added', async () => {
            ...
            assert(result._body.error.includes('password must be at least 3 characters long'))
